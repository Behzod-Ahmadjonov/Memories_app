...
const Auth = () => {
   ...
   const googleFailure = (error) => {
    console.log(error);
    console.log("Google Sing In was unsuccessfull. Try again later");
   };
   const googleSuccess = async (res) => {
    //  const result = res?.profileObj; // ?. is an operator that trhow on errors
   ...
   <Container component="main" maxWidth="xs">
      <Paper className={classes.paper} elevation={3}>
        ...
        <Typography variant='h5'>
          ...
          <form classanme={classes.form} onSubmit={handleSubmit}>
